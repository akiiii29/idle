...
import { type GameItem, rollLootDrop, WEAPON_POOL, ARMOR_POOL, getItemsByRarity, pickRandomItem, computeCombatStats, calculatePipelineDamage, applySkills, type CombatContext, applyPetEffects, applyPetSynergy, HOSPITAL_COOLDOWN_MS } from "@game/core";
