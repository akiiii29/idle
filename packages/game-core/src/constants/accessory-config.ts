...
export const ACCESSORY_SETS: Record<string, { bonus2: AccessoryEffect[], bonus3: AccessoryEffect[] }> = {
    ...
    "Flame": {
        ...
        bonus3: [{ type: "PROC_CHANCE", power: 0.01 }]
    },
    "Venom": {
    ...
    "Speed": {
        ...
        bonus3: [{ type: "MULTI_HIT", power: 0.5 }]
    },
    "Guardian": {
        bonus2: [{ type: "REDUCE_DMG", power: 0.15 }],
        bonus3: [{ type: "REDUCE_DMG", power: 0.2 }]
    },
    "Gambler": {
        bonus2: [{ type: "PROC_CHANCE", power: 0.15 }],
        bonus3: [{ type: "PROC_CHANCE", power: 0.5 }]
    },
    "Berserker": {
    ...
    "Beast": {
        ...
        bonus3: [{ type: "PET_PLAYER_SYN", power: 1.0 }]
    },
    "Elemental": {
        bonus2: [{ type: "HYBRID_BURN_POISON", power: 0.25 }],
        bonus3: [{ type: "HYBRID_BURN_POISON", power: 1.0 }]
    }
};

export const ACCESSORY_CONFIGS: Record<string, AccessoryConfig> = {
    // Assassin Set
    "Nhẫn Sát Thủ": { name: "Nhẫn Sát Thủ", rarity: "RARE", set: "Assassin", effects: [{ type: "CRIT_CHANCE", power: 0.1 }] },
    "Dây Chuyền Bóng Tối": { name: "Dây Chuyền Bóng Tối", rarity: "EPIC", set: "Assassin", effects: [{ type: "CRIT_DMG", power: 0.25 }] },
    "Mặt Nạ Đâm Lén": { name: "Mặt Nạ Đâm Lén", rarity: "LEGENDARY", set: "Assassin", effects: [{ type: "UNIQUE_CRIT_EXECUTE", power: 0.3 }] },

    // Flame Set
    "Nhẫn Lửa": { name: "Nhẫn Lửa", rarity: "RARE", set: "Flame", effects: [{ type: "BURN_DMG", power: 0.25 }] },
    "Bùa Tro Tàn": { name: "Bùa Tro Tàn", rarity: "EPIC", set: "Flame", effects: [{ type: "BURN_DUR", power: 1 }] },
    "Trái Tim Hỏa Ngục": { name: "Trái Tim Hỏa Ngục", rarity: "LEGENDARY", set: "Flame", effects: [{ type: "UNIQUE_BURN_INSTANT", power: 0.2 }] },

    // Venom Set
    "Trâm Độc": { name: "Trâm Độc", rarity: "RARE", set: "Venom", effects: [{ type: "POISON_DMG", power: 0.2 }] },
    "Bình Độc Cổ": { name: "Bình Độc Cổ", rarity: "EPIC", set: "Venom", effects: [{ type: "POISON_DUR", power: 2 }] },
    "Nanh Rắn Vua": { name: "Nanh Rắn Vua", rarity: "LEGENDARY", set: "Venom", effects: [{ type: "UNIQUE_POISON_BURST", power: 0 }] },

    // Blood Set
    "Nhẫn Huyết": { name: "Nhẫn Huyết", rarity: "RARE", set: "Blood", effects: [{ type: "LIFESTEAL", power: 0.15 }] },
    "Bùa Hút Sinh Lực": { name: "Bùa Hút Sinh Lực", rarity: "EPIC", set: "Blood", effects: [{ type: "LIFESTEAL", power: 0.25 }] },
    "Tim Quỷ": { name: "Tim Quỷ", rarity: "LEGENDARY", set: "Blood", effects: [{ type: "UNIQUE_LIFE_DOUBLE", power: 0.5 }] },

    // Speed Set
    "Nhẫn Tốc Độ": { name: "Nhẫn Tốc Độ", rarity: "RARE", set: "Speed", effects: [{ type: "MULTI_HIT", power: 0.1 }] },
    "Giày Gió": { name: "Giày Gió", rarity: "EPIC", set: "Speed", effects: [{ type: "MULTI_HIT", power: 0.3 }] },
    "Linh Hồn Gió": { name: "Linh Hồn Gió", rarity: "LEGENDARY", set: "Speed", effects: [{ type: "MULTI_HIT", power: 0.15 }] },

    // Guardian Set
    "Khiên Cổ": { name: "Khiên Cổ", rarity: "RARE", set: "Guardian", effects: [{ type: "REDUCE_DMG", power: 0.1 }] },
    "Dây Chuyền Thép": { name: "Dây Chuyền Thép", rarity: "EPIC", set: "Guardian", effects: [{ type: "REDUCE_DMG", power: 0.2 }] },
    "Trái Tim Titan": { name: "Trái Tim Titan", rarity: "LEGENDARY", set: "Guardian", effects: [{ type: "UNIQUE_BLOCK_HIT", power: 1 }] },

    // Gambler Set
    "Xúc Xắc Hỗn Loạn": { name: "Xúc Xắc Hỗn Loạn", rarity: "RARE", set: "Gambler", effects: [{ type: "PROC_CHANCE", power: 0.1 }] },
    "Đồng Xu May Rủi": { name: "Đồng Xu May Rủi", rarity: "EPIC", set: "Gambler", effects: [{ type: "PROC_CHANCE", power: 0.2 }] },
    "Mặt Nạ Điên Loạn": { name: "Mặt Nạ Điên Loạn", rarity: "LEGENDARY", set: "Gambler", effects: [{ type: "UNIQUE_PROC_TWICE", power: 0.2 }] },

    // Berserker Set
    "Nhẫn Tử Chiến": { name: "Nhẫn Tử Chiến", rarity: "RARE", set: "Berserker", effects: [{ type: "LOW_HP_DMG", power: 0.2 }] },
    "Huyết Ấn": { name: "Huyết Ấn", rarity: "EPIC", set: "Berserker", effects: [{ type: "LOW_HP_DMG", power: 0.3 }] },
    "Linh Hồn Cuồng Nộ": { name: "Linh Hồn Cuồng Nộ", rarity: "LEGENDARY", set: "Berserker", effects: [{ type: "UNIQUE_BERSERK_PERCENT", power: 0.01 }] },

    // Beast Set
    "Dây Xích Thú": { name: "Dây Xích Thú", rarity: "RARE", set: "Beast", effects: [{ type: "PET_DMG", power: 0.2 }] },
    "Ấn Thú": { name: "Ấn Thú", rarity: "EPIC", set: "Beast", effects: [{ type: "PET_CHANCE", power: 0.15 }] },
    "Trái Tim Hoang Dã": { name: "Trái Tim Hoang Dã", rarity: "LEGENDARY", set: "Beast", effects: [{ type: "PET_PLAYER_SYN", power: 0.2 }] },

    // Elemental Set
    "Nhẫn Nguyên Tố": { name: "Nhẫn Nguyên Tố", rarity: "RARE", set: "Elemental", effects: [{ type: "HYBRID_BURN_POISON", power: 0.15 }] },
    "Mặt Dây Nguyên Tố": { name: "Mặt Dây Nguyên Tố", rarity: "EPIC", set: "Elemental", effects: [{ type: "HYBRID_BURN_POISON", power: 0.3 }] },
    "Lõi Nguyên Tố": { name: "Lõi Nguyên Tố", rarity: "LEGENDARY", set: "Elemental", effects: [{ type: "HYBRID_BURN_POISON", power: 0.5 }] },
};
