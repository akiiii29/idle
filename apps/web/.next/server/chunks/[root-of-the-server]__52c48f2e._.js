module.exports = [
"[project]/apps/web/.next-internal/server/app/api/quests/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
async function GET(req) {
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTS"].map((q)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].quest.upsert({
            where: {
                key: q.key
            },
            create: {
    ...
    const now = new Date();
    const userQuestMap = new Map(user.quests.map((uq)=>[
            uq.quest.key,
            uq
        ]));
    const daily = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTS"].filter((q)=>q.type === "DAILY").map((q)=>{
    ...
    const weekly = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTS"].filter((q)=>q.type === "WEEKLY").map((q)=>{
        const uq = userQuestMap.get(q.key);
        return {
            key: q.key,
            description: q.description,
    ...
    const achievements = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["QUESTS"].filter((q)=>q.type === "ACHIEVEMENT").map((q)=>{
        const uq = userQuestMap.get(q.key);
        return {
            key: q.key,
            description: q.description,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__52c48f2e._.js.map