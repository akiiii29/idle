module.exports = [
"[project]/apps/web/.next-internal/server/app/api/shop/buy/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/shop/buy/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function buyConsumable(userId, slot) {
    const listing = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.findUnique({
        where: {
            userId_slot: {
                userId,
                slot
    ...
    const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCatalogEntry"])(listing.itemKey);
    if (!item) return {
        success: false,
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].item.create({
            data: {
                ...
                type: item.type,
                power: item.power,
                rarity: item.tier === 1 ? "COMMON" : item.tier === 2 ? "RARE" : "EPIC",
                quantity: 1,
                bonusStr: 0,
                bonusAgi: 0,
                bonusDef: 0,
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.update({
            where: {
                id: listing.id
            },
            data: {
...
async function buyEquipment(userId, slot, _price) {
    ...
    let itemData = null;
    try {
        itemData = JSON.parse(listing.itemKey);
    } catch  {}
    if (!itemData) return {
        success: false,
        message: "Item data corrupted."
    };
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: userId
    ...
    return {
        success: true,
        message: `Purchased **${itemData.name}** (${itemData.rarity})!`
    };
}
// ─── Buy from Accessory Shop (slot 21-25) ─────────────────────────────────────
async function buyAccessory(userId, slot) {
    const listing = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.findUnique({
        where: {
            userId_slot: {
                userId,
    ...
    const acc = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ACCESSORY_CONFIGS"][listing.itemKey];
    if (!acc) return {
        success: false,
        message: "Item no longer exists."
    };
    ...
    return {
        success: true,
        message: `Purchased **${acc.name}**!`
    };
}
// ─── Buy from Dungeon Prep Shop (slot 11-14) ──────────────────────────────────
async function buyDungeon(userId, slot) {
    const listing = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.findUnique({
        where: {
            userId_slot: {
                userId,
    ...
    const { DUNGEON_BUFF_ITEMS } = await __turbopack_context__.A("[project]/packages/game-core/dist/index.js [app-route] (ecmascript, async loader)");
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].item.create({
            data: {
                ...
                type: item.type,
                power: item.power,
                rarity: item.tier === 1 ? "COMMON" : "RARE",
                quantity: 1,
                bonusStr: 0,
                bonusAgi: 0,
                bonusDef: 0,
...
async function refreshShop(userId) {
    ...
    if (user.gold < __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_REFRESH_GOLD"]) return {
        success: false,
        message: `Need ${__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_REFRESH_GOLD"]} gold.`
    };
    const tier1 = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_CATALOG"].filter((e)=>e.tier === 1);
    const tier2 = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_CATALOG"].filter((e)=>e.tier === 2);
    const tier3 = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_CATALOG"].filter((e)=>e.tier === 3);
    const picks = [];
    const usedKeys = new Set();
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            ...
            data: {
                gold: {
                    decrement: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_REFRESH_GOLD"]
                }
            }
        }),
        ...picks.map((item, idx)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.upsert({
                where: {
                    userId_slot: {
                        userId,
                        slot: idx + 1
    ...
    return {
        success: true,
        message: "Shop refreshed!"
    };
}
// ─── Buy Pet ─────────────────────────────────────────────────────────────────
async function buyPet(userId, rarity, price) {
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.findUnique({
        where: {
            id: userId
        }
    ...
    const { PET_CONFIGS } = await __turbopack_context__.A("[project]/packages/game-core/dist/index.js [app-route] (ecmascript, async loader)");
    const candidates = Object.values(PET_CONFIGS).filter((p)=>p.rarity === rarity);
    if (candidates.length === 0) return {
        success: false,
        message: "No pets available for this rarity."
    };
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].beast.create({
            data: {
                ownerId: userId,
                name: petConfig.name,
                rarity: rarity,
    ...
    return {
        success: true,
        message: `Adopted a **${rarity}** pet!`
    };
}
// ─── Buy Chest ───────────────────────────────────────────────────────────────
async function buyChest(userId, chestKey) {
    const chest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getChestEntry"])(chestKey);
    if (!chest) return {
        success: false,
    ...
    if (user.gold < chest.price) return {
        success: false,
        message: `Need ${chest.price} gold.`
    };
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            where: {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].item.create({
            data: {
                ...
                type: "GAMBLE",
                power: 0,
                rarity: chest.tier === 1 ? "COMMON" : chest.tier === 2 ? "RARE" : "EPIC",
                quantity: 1,
                bonusStr: 0,
                bonusAgi: 0,
                bonusDef: 0,
    ...
    return {
        success: true,
        message: `Purchased **${chest.name}**!`
    };
}
async function POST(req) {
    try {
        const { userId, category, slot, price, chestKey } = await req.json();
        if (!userId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        if (category === "refresh") {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(res);
        }
        // Chest purchase
        if (category === "chest") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyChest(userId, chestKey));
        }
        // Consumable shop (slot 1-5)
        if (category === "consumable") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyConsumable(userId, slot));
        }
        // Equipment shop (generated, not DB-persisted)
        if (category === "equipment") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyEquipment(userId, slot, price));
        }
        // Accessory shop (slot 21-25)
        if (category === "accessory") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyAccessory(userId, slot));
        }
        // Dungeon prep shop (slot 11-14)
        if (category === "dungeon") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyDungeon(userId, slot));
        }
        // Pet shop
        if (category === "pet") {
            const { petRarity } = await req.json();
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(await buyPet(userId, petRarity, price));
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21b20545._.js.map