module.exports = [
"[project]/apps/web/.next-internal/server/app/api/shop/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/shop/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const consumableNeedsRoll = consumableListings.length !== SHOP_SLOTS || (consumableListings[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDifferentVnDay"])(consumableListings[0].refreshedAt) : true);
    let consumableSlots = [];
    if (consumableNeedsRoll) {
        ...
        // Upsert
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(picks.map((item, idx)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.upsert({
                where: {
                    userId_slot: {
                        userId,
                        slot: idx + 1
        ...
        consumableSlots = picks.map((item, idx)=>({
                slot: idx + 1,
                item,
                purchased: false
            }));
        ...
        consumableSlots = consumableListings.map((l)=>({
                slot: l.slot,
                item: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCatalogEntry"])(l.itemKey),
    ...
    const eqNeedsRoll = eqListings.length === 0 || (eqListings[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDifferentVnDay"])(eqListings[0].refreshedAt) : true);
    let equipmentSlots = [];
    if (eqNeedsRoll) {
        const eqPool = [
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.deleteMany({
                where: {
                    userId,
                    slot: {
                        gte: EQ_SLOT_START,
                        lt: EQ_SLOT_START + EQ_SHOP_SLOTS
                    }
                }
            }),
            ...selected.map((item, idx)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.create({
                    data: {
                        userId,
    ...
    const { ACCESSORY_CONFIGS } = await __turbopack_context__.A("[project]/packages/game-core/dist/index.js [app-route] (ecmascript, async loader)");
    const accListings = user.shopListings.filter((l)=>l.slot >= ACC_SLOT_START && l.slot < ACC_SLOT_START + ACC_SHOP_SLOTS);
    const accNeedsRoll = accListings.length === 0 || (accListings[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDifferentVnDay"])(accListings[0].refreshedAt) : true);
    ...
    if (accNeedsRoll) {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.deleteMany({
                where: {
                    ...
                    slot: {
                        gte: ACC_SLOT_START,
                        lt: ACC_SLOT_START + ACC_SHOP_SLOTS
                    }
                }
            }),
            ...selected.map((acc, idx)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.create({
                    data: {
                        userId,
        ...
        for(let i = 0; i < selected.length; i++){
            accessorySlots.push({
                slot: ACC_SLOT_START + i,
                item: {
                    name: selected[i].name,
                    rarity: selected[i].rarity,
                    power: 0,
                    price: 150
                },
                purchased: false
    ...
    // ── 4. Chest Shop ───────────────────────────────────────────────────────────
    const chestSlots = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CHEST_CATALOG"].map((item)=>({
            slot: item.key,
            item
        }));
    ...
    const dungeonNeedsRoll = dungeonListings.length === 0 || (dungeonListings[0] ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDifferentVnDay"])(dungeonListings[0].refreshedAt) : true);
    let dungeonSlots = [];
    if (dungeonNeedsRoll) {
        const shuffled = [
            ...__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DUNGEON_BUFF_ITEMS"]
        ].sort(()=>Math.random() - 0.5);
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.deleteMany({
                where: {
                    userId,
                    slot: {
                        gte: DUNGEON_SLOT_START,
                        lt: DUNGEON_SLOT_START + DUNGEON_SHOP_SLOTS
                    }
                }
            }),
            ...selected.map((item, idx)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].shopListing.create({
        ...
        dungeonSlots = dungeonListings.map((l)=>({
                slot: l.slot,
                item: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DUNGEON_BUFF_ITEMS"].find((d)=>d.key === l.itemKey),
                purchased: l.purchased
            }));
    }
    // ── 6. Pet Shop ─────────────────────────────────────────────────────────────
    const petSlots = Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PET_SHOP_PRICES"]).map(([rarity, price])=>({
            rarity,
            price
        }));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        gold: user.gold,
        refreshCost: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SHOP_REFRESH_GOLD"],
        consumableSlots,
        equipmentSlots,
        accessorySlots,
        chestSlots,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a19a82d7._.js.map