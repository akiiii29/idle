module.exports = [
"[project]/apps/web/.next-internal/server/app/api/practice/[userId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/practice/[userId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const results = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["simulateCombat"])({
        player: {
            ...
            critRate,
            pets: equippedPets,
            skills: user.skills?.filter((s)=>s.isEquipped) || [],
            title: user.title
        },
        enemy: {
        ...
        accessories: {
            effects: stats.extra?.activeUniqueEffects || [],
            uniquePowers: stats.extra?.uniquePowers || {},
            sets: stats.extra?.activeSets || []
        },
        maxTurns: 10
    });
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        turnLogs: (results.fullLogs || []).map((l)=>({
                turn: l.turn,
                events: l.events
            })),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__96ebcb4e._.js.map