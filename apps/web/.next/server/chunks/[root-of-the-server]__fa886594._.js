module.exports = [
"[project]/apps/web/.next-internal/server/app/api/skills/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/skills/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    const allSkills = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].skill.findMany();
    // Daily 5
    const daily5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDailySkills"])(userId, allSkills, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getVnDayString"]);
    ...
    const dailySlots = daily5.map((skill)=>({
            ...
            emoji: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SKILL_EMOJIS"][skill.name] ?? "✨",
            description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSkillDescription"])(skill),
            owned: userSkillIds.has(skill.id),
            price: SKILL_PRICE
        }));
    const equippedSkills = user.skills.filter((us)=>us.isEquipped).map((us)=>({
            id: us.skill.id,
            name: us.skill.name,
            type: us.skill.type,
            trigger: us.skill.trigger,
            emoji: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SKILL_EMOJIS"][us.skill.name] ?? "✨",
            description: (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSkillDescription"])(us.skill)
        }));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa886594._.js.map