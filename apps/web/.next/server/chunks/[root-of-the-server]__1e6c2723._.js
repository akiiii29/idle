module.exports = [
"[project]/apps/web/.next-internal/server/app/api/hunt/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/lib/game/simulate-battle.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function simulateHunt(userId, user, huntType) {
    const isBoss = huntType === "boss";
    const enemyStrengthMultiplier = isBoss ? 3 : 1;
    // Compute player combat stats
    const combatStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeCombatStats"])({
        str: user.str,
        agi: user.agi,
        maxHp: user.maxHp,
        luck: user.luck ?? 0,
    ...
    }, user.inventory?.filter((i)=>i.isEquipped) ?? [], user.beasts?.filter((b)=>b.isEquipped).map((b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrichBeast"])(b)) ?? [], [], undefined);
    ...
    const player = {
        ...
        pets: user.beasts?.filter((b)=>b.isEquipped).map((b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrichBeast"])(b)) ?? [],
        skills: user.skills?.filter((us)=>us.isEquipped).map((us)=>us.skill) ?? [],
        title: user.title ?? null
    };
    const enemy = {
        name: enemyName,
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["simulateCombat"])({
        player,
        enemy
    });
    return result;
...
"[project]/apps/web/src/lib/pet-server.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function addPetExp(petId, expAmount, tx) {
    const pet = await tx.beast.findUnique({
        where: {
            id: petId
        }
    });
...
"[project]/apps/web/src/app/api/hunt/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$game$2f$simulate$2d$battle$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/game/simulate-battle.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pet$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/pet-server.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$constants$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/packages/game-core/dist/constants/index.js [app-route] (ecmascript)");
;
;
;
;
...
function rollItemRarity(bossKill) {
...
function pickRandomItem(rarity) {
    const pool = __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$constants$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ALL_ITEMS"].filter((i)=>i.rarity === rarity);
    if (pool.length === 0) return null;
    return pool[Math.floor(Math.random() * pool.length)];
}
function makeInventoryEntry(item, userId) {
    return {
        userId,
        name: item.name,
        type: item.type,
...
async function POST(request) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$game$2f$simulate$2d$battle$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["simulateHunt"])(userId, user, huntType);
    ...
    // Update user in DB
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction(async (tx)=>{
        ...
        if (isWin) {
            await tx.combatLog.create({
                data: {
                    ...
                    goldGained,
                    expGained,
                    logDetails: result.fullLogs?.map((l)=>l.events).flat().join("\n")?.substring(0, 5000) ?? ""
                }
            });
            // Boss drop items
        ...
        if (result.combatSummary?.petExpPool) {
            for (const [petId, amount] of result.combatSummary.petExpPool.entries()){
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$pet$2d$server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addPetExp"])(petId, amount, tx);
            }
        }
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        goldGained,
        expGained,
        battleLogs: result.fullLogs?.flatMap((l)=>l.events) ?? [],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1e6c2723._.js.map