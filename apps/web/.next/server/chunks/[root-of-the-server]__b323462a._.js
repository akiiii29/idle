module.exports = [
"[project]/apps/web/.next-internal/server/app/api/synergy/[userId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/synergy/[userId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    const skillFlags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$constants$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["flagsFromPlayerSkillNames"])([
        ...ownedSkillNames
    ]);
    const petFlags = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$constants$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["flagsFromEquippedPets"])(user.beasts ?? []);
    const active = [];
    const potential = [];
    for (const syn of __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYNERGY_LIST"]){
    ...
    const petComboSyns = [
        {
            ...
            met: skillFlags.has("didCrit") && petFlags.has("petCrit") ? [
                "didCrit",
                "petCrit"
            ] : [],
            missing: skillFlags.has("didCrit") && petFlags.has("petCrit") ? [] : (!skillFlags.has("didCrit") ? [
                "didCrit"
            ] : []).concat(!petFlags.has("petCrit") ? [
                "petCrit"
            ] : [])
        },
        {
            ...
            met: skillFlags.has("didBurn") && petFlags.has("petBurn") ? [
                "didBurn",
                "petBurn"
            ] : [],
            missing: skillFlags.has("didBurn") && petFlags.has("petBurn") ? [] : (!skillFlags.has("didBurn") ? [
                "didBurn"
            ] : []).concat(!petFlags.has("petBurn") ? [
                "petBurn"
            ] : [])
        },
        {
            ...
            met: skillFlags.has("didPoison") && petFlags.has("petPoison") ? [
                "didPoison",
                "petPoison"
            ] : [],
            missing: skillFlags.has("didPoison") && petFlags.has("petPoison") ? [] : (!skillFlags.has("didPoison") ? [
                "didPoison"
            ] : []).concat(!petFlags.has("petPoison") ? [
                "petPoison"
            ] : [])
        },
        {
            ...
            met: petFlags.has("petBurn") && petFlags.has("petPoison") ? [
                "petBurn",
                "petPoison"
            ] : [],
            missing: petFlags.has("petBurn") && petFlags.has("petPoison") ? [] : (!petFlags.has("petBurn") ? [
                "petBurn"
            ] : []).concat(!petFlags.has("petPoison") ? [
                "petPoison"
            ] : [])
        },
        {
            ...
            met: skillFlags.has("didDamageReduction") && petFlags.has("petShield") ? [
                "didDamageReduction",
                "petShield"
            ] : [],
            missing: skillFlags.has("didDamageReduction") && petFlags.has("petShield") ? [] : (!skillFlags.has("didDamageReduction") ? [
                "didDamageReduction"
            ] : []).concat(!petFlags.has("petShield") ? [
                "petShield"
            ] : [])
        },
        {
            ...
            met: skillFlags.has("didLifesteal") && petFlags.has("petHeal") ? [
                "didLifesteal",
                "petHeal"
            ] : [],
            missing: skillFlags.has("didLifesteal") && petFlags.has("petHeal") ? [] : (!skillFlags.has("didLifesteal") ? [
                "didLifesteal"
            ] : []).concat(!petFlags.has("petHeal") ? [
                "petHeal"
            ] : [])
        },
        {
            ...
            met: skillFlags.has("didCrit") && petFlags.has("petDebuff") ? [
                "didCrit",
                "petDebuff"
            ] : [],
            missing: skillFlags.has("didCrit") && petFlags.has("petDebuff") ? [] : (!skillFlags.has("didCrit") ? [
                "didCrit"
            ] : []).concat(!petFlags.has("petDebuff") ? [
                "petDebuff"
            ] : [])
        },
        {
            ...
            met: petFlags.has("petCrit") ? [
                "petCrit"
            ] : [],
            missing: petFlags.has("petCrit") ? [] : [
                "petCrit"
            ]
        }
    ];
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        active,
        potential,
        total: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SYNERGY_LIST"].length + petComboSyns.length,
        petSkillCombos
    });
}
function hasFlag(flag, skillFlags, petFlags) {
    const petOnlyFlags = [
        "petCrit",
        "petBurn",
        "petPoison",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b323462a._.js.map