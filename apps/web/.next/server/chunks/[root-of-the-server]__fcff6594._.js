module.exports = [
"[project]/apps/web/.next-internal/server/app/api/auto-hunt/[userId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
function computeCombatStats(user, items, pets = [], buffs = [], petMultipliers) {
    ...
    for (const item of equipped){
        ...
        if (item.type === "ACCESSORY" || item.type === "ACCESSORY") {
            accessories.push({
                ...item,
                upgradeLevel
            });
        ...
        const tag = item.type === "WEAPON" || item.type === "WEAPON" ? "⚔️" : "🛡️";
        const bits = [
            wPow ? `WP ${wPow}` : null,
            bStr ? `STR+${bStr}` : null,
            bAgi ? `AGI+${bAgi}` : null,
...
"[project]/apps/web/src/app/api/auto-hunt/[userId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MAX_FIGHTS = 20;
function calcReward(baseReward, streak, fightIndex, isAuto) {
...
async function POST(request) {
    ...
    if (charges <= 0) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "No auto-hunt charges remaining"
        }, {
            status: 400
        });
    }
    ...
    const equippedPets = user.beasts?.filter((b)=>b.isEquipped).map((b)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["enrichBeast"])(b)) || [];
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeCombatStats"])({
        str: user.str,
        agi: user.agi,
        maxHp: user.maxHp,
        luck: user.luck ?? 0,
    ...
    for(let n = 0; n < MAX_FIGHTS; n++){
        ...
        if (!isWin) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
                ...
                ...potionsUsed > 0 && potionStack ? [
                    __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].item.update({
                        where: {
                            id: potionStack.id
                        },
                        data: {
                            quantity: {
                                decrement: potionsUsed
                            }
                        }
                    })
                ] : []
        ...
        const lifestealFactor = (stats.multiplier?.lifesteal || 1) - 1;
        ...
        fightsLog.push({
            ...
            exp: expReward.amount,
            jackpot: goldReward.isJackpot
        });
    }
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$transaction([
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].user.update({
            ...
            data: {
                gold: {
                    increment: accumulatedGold
                },
                exp: {
                    increment: accumulatedExp
                },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fcff6594._.js.map