module.exports = [
"[project]/apps/web/.next-internal/server/app/api/profile/[userId]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/web/src/app/api/profile/[userId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    }, equippedItems, equippedPets, []);
    // Parse equipped titles
    let equippedKeys = [];
    try {
        if (user.title) {
            equippedKeys = user.title.startsWith("[") ? JSON.parse(user.title) : [
                user.title
            ];
        }
    } catch  {}
    const equippedTitles = equippedKeys.map((k)=>__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$game$2d$core$2f$dist$2f$constants$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TITLES"].find((t)=>t.key === k)).filter((t)=>!!t);
    // Top pet by power
    const topBeast = [
        ...user.beasts ?? []
    ...
    const equippedSkillCount = user.skills?.filter((s)=>s.isEquipped).length ?? 0;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$5$2e$15_react$2d$dom$40$19$2e$2$2e$5_react$40$19$2e$2$2e$5_$5f$react$40$19$2e$2$2e$5$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        topBeast: topBeast ? {
            name: topBeast.name,
            rarity: topBeast.rarity,
            power: topBeast.power ?? 0
        } : null,
        equippedSkillCount,
        inventoryCount: (user.inventory ?? []).filter((i)=>i.quantity > 0).length,
        ...
        tavernCdMs: tavernCd,
        equippedItems,
        equippedPets: equippedPets.map((p)=>({
                id: p.id,
                name: p.name,
                rarity: p.rarity,
                power: p.power,
        ...
        inventory: (user.inventory ?? []).filter((i)=>i.quantity > 0 && i.isEquipped).slice(0, 6)
    });
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__95856450._.js.map