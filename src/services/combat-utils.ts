/**
 * combat-utils.ts
 * Pure combat logic utilities as specified by Goal 1-7.
 * Refined by Senior Combat Systems Engineer.
 */

import { type CombatParticipant, type CombatEffect } from "../types/combat";

/**
 * Scalable Damage Formula (Goal 7 / Revision)
 * rawDmg = atk
...
/**
 * Core Damage Application (Goal 3)
...
/**
 * Advanced Effect Stacking (Goal 5)
...
/**
 * Turn-Start Effect Resolution (Goal 1)
 */
  ...
  for (const e of effects) {
    ...
    switch (e.type) {
      ...
      case "dot":
        ...
        applyDamage(target, dotDmg, events); // Uses shield system
        break;
      case "poison":
